...
export default function BalancePage() {
  ...
  const next = useCallback(() => {
    // Level up within the chosen difficulty band
  ...
  return (
    <div className="h-[100dvh] overflow-hidden bg-gradient-to-b from-indigo-50 to-purple-50 p-3 flex flex-col">
        ...
        {phase === "select" ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-4">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">どちらが おおきい？ くらべてみよう</p>
            </div>
          ...
          <>
            {/* Stats bar */}
            <div className="bg-white/90 border border-indigo-200 rounded-2xl p-3 mb-3 shadow-sm flex-shrink-0">
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-3 min-h-0">
              {/* The balance scale */}
              <div className="relative w-full max-w-xs h-48 flex-shrink-0">
                {/* Fulcrum */}
              ...
              {showDots && (
                <div className="w-full grid grid-cols-2 gap-3 animate-[fadeIn_0.3s_ease-out] flex-shrink-0">
              ...
              {/* Choice buttons */}
              {phase === "choose" ? (
                <div className="flex gap-3 w-full max-w-xs flex-shrink-0">
                  <button
                ...
                <button
                  onClick={next}
                  className="mc-btn text-lg px-8 py-3 flex-shrink-0"
                >
                  つぎへ！
                </button>
              )}
